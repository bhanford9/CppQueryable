// #ifndef CPPQUERYABLE_QUERYABLE_SELECTABLEDATA_H
// #define CPPQUERYABLE_QUERYABLE_SELECTABLEDATA_H
//
// #include <algorithm>
// #include <deque>
// #include <exception>
...
//   typename TIn,
//   typename TOut,
//   template<typename, typename ...> typename TIterable, typename ...TArgs>
// class SelectableData : virtual public IQueryableData<TIn>
// {
//   static_assert(can_iterate<TIterable<TIn, TArgs...>>::value, "Class must be able to be iterated over");
// protected:
//   TIterable<TOut, TArgs...> items;
//
//   typedef typename TIterable<TIn, TArgs...>::iterator t_forwardIterator;
//   typedef typename TIterable<TIn, TArgs...>::reverse_iterator t_reverseIterator;
//
//   Iterator<TIn> beginning;
//   Iterator<TIn> ending;
//
//   Iterator<TIn> rbeginning;
//   Iterator<TIn> rending;
//
...
//     beginning.Equal = [&](const Iterator<TIn>& value) { return this->beginIterator == *static_cast<t_forwardIterator*>(value.Get()); };
//     beginning.Dereference = [&]() -> TOut& { this->value = *this->beginIterator; return this->value; };
//     beginning.ConstDereference = [&]() -> const TOut& { return *this->beginIterator; };
...
//     beginning.Assign = [&](const Iterator<TIn> & value) { this->beginIterator = t_forwardIterator(*static_cast<t_forwardIterator*>(value.Get())); };
