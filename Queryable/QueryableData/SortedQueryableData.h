...
class SortedQueryableData : public QueryableData<T, T, TIterable, std::function<bool(T, T)>, TArgs...>
{
protected:
...
public:
  ...
  SortedQueryableData(
    ...
    : QueryableData<T, T, TIterable, std::function<bool(T, T)>>(items)
  {
    this->comparator = compare;
  }

  SortedQueryableData(const SortedQueryableData<T, TIterable, TArgs...> & data)
    : QueryableData<T, T, TIterable, std::function<bool(T, T)>>(data)
  {
