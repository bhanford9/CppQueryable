...
{
protected:
  VectorInternalQueryable<Person> queryablePeople;
  VectorInternalQueryable<int> queryableInts;
...
{
  VectorInternalQueryable<int> localQueryable;
...
{
  VectorInternalQueryable<int> localQueryable(std::vector<int>({ 9 }));
  std::vector<int> localVector;
...
{
  SetInternalQueryable<int> localQueryable;
...
{
  SetInternalQueryable<int> localQueryable(std::set<int>({ 9 }));
  std::set<int> localSet;
...
TEST_F(EqualFunctionalTest, EqualSetQueryOneExtraTest)
{
  ...
  SetInternalQueryable<int> queryableSet = BuildQueryable(this->queryableInts.ToSet());
...
{
  MultiSetInternalQueryable<int> localQueryable;
...
{
  MultiSetInternalQueryable<int> localQueryable(std::multiset<int>({ 9 }));
  std::multiset<int> localMultiSet;
...
TEST_F(EqualFunctionalTest, EqualMultiSetQueryOneExtraTest)
{
  ...
  MultiSetInternalQueryable<int> queryableMultiSet = BuildQueryable(this->queryableInts.ToMultiSet());
...
{
  DequeInternalQueryable<int> localQueryable;
...
{
  DequeInternalQueryable<int> localQueryable(std::deque<int>({ 9 }));
  std::deque<int> localDeque;
...
TEST_F(EqualFunctionalTest, EqualDequeQueryOneExtraTest)
{
  ...
  DequeInternalQueryable<int> queryableDeque = BuildQueryable(this->queryableInts.ToDeque());
...
{
  ListInternalQueryable<int> localQueryable;
...
{
  ListInternalQueryable<int> localQueryable(std::list<int>({ 9 }));
  std::list<int> localList;
...
TEST_F(EqualFunctionalTest, EqualListQueryOneExtraTest)
{
  ...
  ListInternalQueryable<int> queryableList(this->queryableInts.ToList());
...
{
  VectorInternalQueryable<Person> localQueryable;
...
{
  VectorInternalQueryable<Person> localQueryable = BuildQueryable(std::vector<Person>({ this->GetPersonWithId(1) }));
  std::vector<Person> localVector;
...
{
  SetInternalQueryable<Person> localQueryable;
...
{
  SetInternalQueryable<Person> localQueryable(std::set<Person>({ this->GetPersonWithId(1) }));
...
TEST_F(EqualFunctionalTest, EqualCustomSetQueryOneExtraTest)
{
  ...
  SetInternalQueryable<Person> localQueryable(this->queryablePeople.ToSet());
  ASSERT_FALSE(localQueryable.Equal(localSet, LikeIds));
}
...
{
  MultiSetInternalQueryable<Person> localQueryable;
...
{
  MultiSetInternalQueryable<Person> localQueryable(std::multiset<Person>({ this->GetPersonWithId(1) }));
...
TEST_F(EqualFunctionalTest, EqualCustomMultiSetQueryOneExtraTest)
{
  ...
  MultiSetInternalQueryable<Person> localQueryable(this->queryablePeople.ToMultiSet());
  ASSERT_FALSE(localQueryable.Equal(localMultiSet, LikeIds));
}
...
{
  DequeInternalQueryable<Person> localQueryable;
...
{
  DequeInternalQueryable<Person> localQueryable = BuildQueryable(std::deque<Person>({ this->GetPersonWithId(1) }));
...
TEST_F(EqualFunctionalTest, EqualCustomDequeQueryOneExtraTest)
{
  ...
  DequeInternalQueryable<Person> localQueryable(this->queryablePeople.ToDeque());
  ASSERT_FALSE(localQueryable.Equal(localDeque, LikeIds));
}
...
{
  ListInternalQueryable<Person> localQueryable;
...
{
  ListInternalQueryable<Person> localQueryable(std::list<Person>({ this->GetPersonWithId(1) }));
...
TEST_F(EqualFunctionalTest, EqualCustomListQueryOneExtraTest)
{
  ...
  ListInternalQueryable<Person> localQueryable(this->queryablePeople.ToList());
  ASSERT_FALSE(localQueryable.Equal(localList, LikeIds));
}
