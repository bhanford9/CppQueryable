...
#ifndef CPPQUERYABLE_CPPQUERYABLETEST_QUERYABLE_PERFORMANCE_TIME_TESTSUITES_ATTIMETEST_H
#define CPPQUERYABLE_CPPQUERYABLETEST_QUERYABLE_PERFORMANCE_TIME_TESTSUITES_ATTIMETEST_H
...
class AtTimeTest final : public BaseTimeTest
{
public:
  AtTimeTest()
  {
...
protected:
  ...
  {
    // there is no load associated with getting the nth element, so no parameter variations
    // are made for that data point
